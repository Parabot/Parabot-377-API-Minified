...
import org.rev377.min.accessors.Deque;
import org.rev377.min.accessors.Node;
	...
	public static final GroundItem[] getGroundItemsAt(final int x, final int y) {
		try {
			...
			while (curNode != null && curNode != holder
				...
				final org.rev377.min.accessors.Item groundItem = (org.rev377.min.accessors.Item) curNode;
